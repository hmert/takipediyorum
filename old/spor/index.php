		...
		<div id="site">
			...
			<div id="content">
				...
				<div class="container thirds">
					<div class="section">
						<?php echo newsblocks::listing('http://www.ajansspor.com/rss/satirbaslari.xml'
						, array(
							'more'=>false,
							'more_fx'=>false,
							'items' => 5
					...
					<div class="section">
						<?php echo newsblocks::listing('http://www.sporx.com/xml/?u=1&tip=rss', array(
							'more'=>false,
							'more_fx'=>false,
							'items' => 5
						)); ?>
					...
					<div class="section">
						<?php echo newsblocks::listing('http://www.internetspor.com/rss/rss.xml', array(
							'more'=>false,
							'more_fx'=>false,
							'items' => 5
						)); ?>
					...
					<div class="section">
						<?php echo newsblocks::listing('http://fanatik.ekolay.net/Fanatik/rss.aspx', array(
							'more'=>false,
							'more_fx'=>false,
							'items' => 5
						)); ?>
					...
					<div class="section">
						<?php echo newsblocks::listing('http://www.spor3.com/rss/rss.xml', array(
							'more'=>false,
							'more_fx'=>false,
							'items' => 5
						)); ?>
					...
					<div class="section">
						<?php echo newsblocks::listing('http://rss.ekolay.net/pages/spor.aspx', array(
							'more'=>false,
							'more_fx'=>false,
							'items' => 5
						)); ?>
					...
					<div class="section">
						<?php echo newsblocks::listing('http://www.ntvmsnbc.com/id/24928011/device/rss/rss.xml', array(
							'more'=>false,
							'more_fx'=>false,
							'items' => 5
						)); ?>
					...
					<div class="section">
						<?php echo newsblocks::listing('http://www.galatasaray.org/xml/gs.rss', array(
							'more'=>false,
							'more_fx'=>false,
							'items' => 5
						)); ?>
